  ...
  if (isBrowserOnline()) {
    checkWebpageAvailability(webpageUrl, function(isAvailable) {
      if (isAvailable) {
        ...
        statusMessage.innerHTML = 'Notepad4UrduBar is inaccessible, contact urdujini@gmail.com or <a href="https://www.ajsoftpk.com/urdubar/notepad4urdubar/">Click Here</a>';
      }
    });
  } else {
